...
using demo_episerver11.Models.Blocks;
...
namespace demo_episerver11.Models.Pages
{
    ...
    [AvailableContentTypes(
        ...
        Include = new[] { typeof(ContainerPage), typeof(ProductPage), typeof(StandardPage), typeof(ISearchPage), typeof(LandingPage), typeof(ContentFolder), typeof(DemoPage) }, // Pages we can create under the start page...
